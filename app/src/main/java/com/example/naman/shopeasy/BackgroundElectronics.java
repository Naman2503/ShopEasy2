...
public class BackgroundElectronics extends AsyncTask<String,Void,String> {

    Context ctx;
    public BackgroundElectronics(Context ctx)
    {
        this.ctx=ctx;
    ...
    protected String doInBackground(String... params) {
        String reg_url="http://192.168.0.110/project/Electronicssend.php";
        ...
        if (method.equals("register"))
        {
            ...
            String Customer_description=params[6];
            String Customer_img=params[7];
            Log.d("TAG","param in doInBack"+Customer_name+""+""+Customer_brand+""+Customer_price+""+
                    Customer_warranty+""+Customer_quantity+""+Customer_description+""+Customer_img);
            try {
