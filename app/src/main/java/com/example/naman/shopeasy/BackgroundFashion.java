...
public class BackgroundFashion extends AsyncTask<String,Void,String> {

    Context ctx;
    public BackgroundFashion(Context ctx)
    {
        this.ctx=ctx;
    ...
    protected String doInBackground(String... params) {
        String reg_url="http://192.168.0.110/project/Fashionsend.php";
        ...
        if (method.equals("register"))
        {
            ...
            String Customer_category=params[4];
            String Customer_size=params[5];
            String Customer_quantity=params[6];
            String Customer_description=params[7];
            String Customer_img=params[8];
            Log.d("TAG","param in doInBack"+Customer_name+""+""+Customer_brand+""+Customer_price+""+
                    Customer_category+""+Customer_size+""+Customer_quantity+""+Customer_description+""+Customer_img);
            try {
                ...
                String data= URLEncoder.encode("Customer_name","UTF-8")+"="+ URLEncoder.encode(Customer_name,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("Customer_category","UTF-8")+"="+ URLEncoder.encode(Customer_category,"UTF-8")+"&"+
                        URLEncoder.encode("Customer_size","UTF-8")+"="+ URLEncoder.encode(Customer_size,"UTF-8")+"&"+
                        URLEncoder.encode("Customer_quantity","UTF-8")+"="+ URLEncoder.encode(Customer_quantity,"UTF-8")+"&"+
                        URLEncoder.encode("Customer_description","UTF-8")+"="+ URLEncoder.encode(Customer_description,"UTF-8")+"&"+
