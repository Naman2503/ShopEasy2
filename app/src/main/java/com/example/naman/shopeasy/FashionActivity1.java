...
public class FashionActivity1 extends AppCompatActivity implements View.OnClickListener{
    EditText n,b,p,c,s,q,d;
    String n1,b1,p1,c1,s1,q1,d1;
    Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fashion1);
        n= (EditText) findViewById(R.id.namee1);
        b=(EditText)findViewById(R.id.brande1);
        p=(EditText)findViewById(R.id.pricee1);
        c=(EditText)findViewById(R.id.categorye1);
        s=(EditText)findViewById(R.id.sizee1);
...
//validation
        ...
        {
            c.setError("Fill Category");
            return;
        }
        else if (s.getText().toString().length() == 0)
        {
            s.setError("Fill Size");
            return;
        }
...
//validation END
        ...
        if (isOnline())
        {
            ...
            s1=s.getText().toString().trim();
            q1=q.getText().toString().trim();
            d1=d.getText().toString().trim();
           // Toast.makeText(this, "result"+n1+" "+b1+" "+p1+" "+c1+" "+s1+" "+q1, Toast.LENGTH_SHORT).show();
            String method="register";

            Log.d("TAG","4"+n1+""+b1+""+p1+""+c1+""+s1+""+q1);
            Toast.makeText(this, "connection is ok", Toast.LENGTH_SHORT).show();
            Log.d("TAG","bt start");
            BackgroundFashion backgroundTask=new BackgroundFashion(this);
            backgroundTask.execute(method,n1,b1,p1,c1,s1,q1,d1,encodedImage);
            Log.d("TAG","bt end");
            ...
            if (requestCode == 0) {
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        //Toast.makeText(FashionActivity1.this, encodedImage, Toast.LENGTH_SHORT).show();
                        Toast.makeText(FashionActivity1.this, "Wait for moment ....", Toast.LENGTH_SHORT).show();
                        break;
