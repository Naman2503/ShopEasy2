...
public class HomeAndKitchenActivity1 extends AppCompatActivity implements View.OnClickListener{
    EditText n,b,p,w,q,t,f;
    String n1,b1,p1,w1,q1,t1,f1;
    Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_and_kitchen1);
...
//validation END
        ...
        if (isOnline())
        {
            ...
            t1=q.getText().toString().trim();
            f1=f.getText().toString().trim();
            //Toast.makeText(this, "result"+n1+" "+b1+" "+p1+" "+w1+" "+q1+" "+f1, Toast.LENGTH_SHORT).show();
            String method="register";

            Log.d("TAG","4");
            Toast.makeText(this, "connection is ok", Toast.LENGTH_SHORT).show();
            Log.d("TAG","bt start");
            BackgroundHomeAndKitchen backgroundTask=new BackgroundHomeAndKitchen(this);
            backgroundTask.execute(method,n1,b1,p1,w1,q1,t1,f1,encodedImage);
            Log.d("TAG","bt end");
            ...
            if (requestCode == 0) {
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        //Toast.makeText(HomeAndKitchenActivity1.this, encodedImage, Toast.LENGTH_SHORT).show();
                        Toast.makeText(HomeAndKitchenActivity1.this, "Wait for moment ....", Toast.LENGTH_SHORT).show();
                        break;
